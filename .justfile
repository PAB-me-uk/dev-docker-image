...
# Build all images.
build-images no-cache="": (build-image "3.10" no-cache) (build-image "3.11" no-cache) (build-image "3.12" no-cache) (build-image "3.13" no-cache) (build-image "3.14" no-cache)
...
build-and-upload-images no-cache="": (build-and-upload-image "3.10" no-cache) (build-and-upload-image "3.11" no-cache) (build-and-upload-image "3.12" no-cache) (build-and-upload-image "3.13" no-cache) (build-and-upload-image "3.14" no-cache)
